...
<div class="modal fade" id="modal_adicionar_estudante" tabindex="-1" aria-labelledby="modal_adicionar_estudante" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal_adicionar_estudante_titulo"><b>Adicionar estudante</b></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form method="POST" action="{{ url('/') }}/restrito/gravar_estudante">
          @csrf            
